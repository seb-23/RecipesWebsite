...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        {{--    <link rel="stylesheet" href="https://cdjs.cloudfare.com/ajax/libs/bulma/0.7.5/css/bulma.css">--}}
            ...
            <div id="header" class="container">
                ...
                <div id="menu">
                    <ul>
                        ...
                        <li class="{{ Request::path() === 'template_about' ? 'current_page_item' : '' }}"><a href="/template_about" accesskey="3" title="">About Us</a></li>
